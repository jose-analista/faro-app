...
public class tutoSemaforo3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tuto_semaforo3);
        ...
        btnizquierda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(tutoSemaforo3.this, tutoSemaforo2.class);
        ...
        btnderecha.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(tutoSemaforo3.this, tutoSemaforo4.class);
                startActivity(intent);
            }
        });
        ...
        btnsaltartuto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(tutoSemaforo3.this, MainActivity.class);
                startActivity(intent);
            }
        });
