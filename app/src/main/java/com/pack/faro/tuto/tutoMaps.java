...
public class tutoMaps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tuto_maps);
        ...
        btnizquierda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(tutoMaps.this, tutoSemaforo5.class);
        ...
        btnderecha.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(tutoMaps.this, tutoMaps1.class);
                startActivity(intent);
            }
        });
        ...
        btnsaltartuto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(tutoMaps.this, MainActivity.class);
                startActivity(intent);
            }
        });
    }
