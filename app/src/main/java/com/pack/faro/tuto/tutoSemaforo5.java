...
public class tutoSemaforo5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tuto_semaforo5);
        ...
        btnizquierda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(tutoSemaforo5.this, tutoSemaforo4.class);
        ...
        btnderecha.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(tutoSemaforo5.this, tutoMaps.class);
                startActivity(intent);
            }
        });
        ...
        btnsaltartuto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(tutoSemaforo5.this, MainActivity.class);
                startActivity(intent);
            }
        });
