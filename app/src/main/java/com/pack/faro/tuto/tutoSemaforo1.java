...
public class tutoSemaforo1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tuto_semaforo1);
        ...
        btnizquierda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(tutoSemaforo1.this, tutoSemaforo.class);
        ...
        btnderecha.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(tutoSemaforo1.this, tutoSemaforo2.class);
                startActivity(intent);
            }
        });
        ...
        btnsaltartuto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(tutoSemaforo1.this, MainActivity.class);
                startActivity(intent);
            }
        });
